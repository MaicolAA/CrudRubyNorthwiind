...
ActiveRecord::Schema[7.1].define(version: 2023_10_14_035151) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "categories", primary_key: "category_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
  ...
  create_table "employees", primary_key: "employee_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
  ...
  create_table "orders", primary_key: "order_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
  ...
  create_table "products", primary_key: "product_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
  ...
  create_table "region", primary_key: "region_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
    t.string "region_description", null: false
  end

  create_table "shippers", primary_key: "shipper_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
    t.string "company_name", limit: 40, null: false
    t.string "phone", limit: 24
  end

  create_table "suppliers", primary_key: "supplier_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
    t.string "company_name", limit: 40, null: false
    t.string "contact_name", limit: 30
    t.string "contact_title", limit: 30
    t.string "address", limit: 60
  ...
  create_table "territories", primary_key: "territory_id", id: { type: :string, limit: 20 }, force: :cascade do |t|
    t.string "territory_description", null: false
    t.integer "region_id", limit: 2, null: false
  end

  create_table "us_states", primary_key: "state_id", id: { type: :integer, limit: 2, default: nil }, force: :cascade do |t|
